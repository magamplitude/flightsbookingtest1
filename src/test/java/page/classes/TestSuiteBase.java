...
public class TestSuiteBase {
	...
	{
		driver = getDriverInstance(platform, browser, version, url);			// takes these from xml file
		search = PageFactory.initElements(driver, SearchPageFactory.class);		// commented out in searchpagefactory to use here
    }
	
	public static WebDriver getDriverInstance(String platform, String browser, String version, String url)
			throws MalformedURLException {
		String nodeURL = "http://172.17.8.68:5555/wd/hub";
